...
// We can pass any to the server to specify which SPIFFE IDs to
// request.
...
// bundles. We can pass any to the server to specify which SPIFFE IDs to
// request.
...
const file_workload_proto_rawDesc = "" +
	...
	"\x0fValidateJWTSVID\x12\x17.ValidateJWTSVIDRequest\x1a\x18.ValidateJWTSVIDResponseBAZ?github.com/accuknox/go-spiffe/v2/proto/spiffe/workload;workloadb\x06proto3"
