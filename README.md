...
It leverages the [SPIFFE Workload API](https://github.com/accuknox/spiffe/blob/main/standards/SPIFFE_Workload_API.md), providing high level functionality that includes:
* Establishing mutually authenticated TLS (__mTLS__) between workloads powered by SPIFFE.
* Obtaining and validating [X509-SVIDs](https://github.com/accuknox/spiffe/blob/main/standards/X509-SVID.md) and [JWT-SVIDs](https://github.com/accuknox/spiffe/blob/main/standards/JWT-SVID.md).
* Federating trust between trust domains using [SPIFFE bundles](https://github.com/accuknox/spiffe/blob/main/standards/SPIFFE_Trust_Domain_and_Bundle.md#3-spiffe-bundles).
* Bundle management.

## Documentation

See the [Go Package](https://pkg.go.dev/github.com/accuknox/go-spiffe/v2) documentation.
...
[X509-SVIDs](https://github.com/accuknox/spiffe/blob/main/standards/X509-SVID.md)
and X.509 bundles from the [SPIFFE Workload
API](https://github.com/accuknox/spiffe/blob/main/standards/SPIFFE_Workload_API.md).
